...
my $appender = Log::Log4perl::Appender->new('Log::Log4perl::Appender::String', name => 'test');
my $layout = Log::Log4perl::Layout::PatternLayout->new('%m');
$appender->layout($layout);
$logger->add_appender($appender);
$logger->level($INFO);

my $driver = new_ok('Maximus::Class::Broadcast::Driver::Log4perl' => [(logger => $logger)]);
my $msg = new_ok('Maximus::Class::Broadcast::Message' => [(
	text => 'Hello world!',
)]);
$driver->say($msg);
